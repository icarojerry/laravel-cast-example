...
@section('content-projects')
	<form method="POST" action="@yield('project-form-action')">
		...
		<div class="form-group row">
		    ...
		    <textarea type="password" class="form-control col-sm-10" id="description" name="description" placeholder="Enter project description" required>@yield('project-form-description-default')</textarea>
		</div>
